...
static struct ulib_option options[]
    = {{.key = 'a'},
       ...
       {.key = 'f', .cb = f_cb, .flags = ulib_option_optional_arg},

       {.name = "g-long", .cb = g_cb, .flags = ulib_option_optional_arg},

       {.key = 'h', .name = "h-long", .cb = h_cb, .flags = ulib_option_optional_arg},
       ...
       {.key = 'j', .cb = j_cb, .flags = ulib_option_required_arg},

       {.name = "k-long", .cb = k_cb, .flags = ulib_option_required_arg},

       {.key = 'l', .name = "l-long", .cb = l_cb, .flags = ulib_option_required_arg},
...
static struct ulib_option options_no_cb[]
    = {{.key = 'n', .name = "n-long", .flags = ulib_option_required_arg},
...
static const char *cmdlines[][15] = {
    ...
    {
        "test", "--h-long=h-arg-value-2", "-i", "--m-long", "m-arg-value-1", "-h", 0,
    },
    {
        "test", "--d-long", 0,
    },
    ...
    {
        "test", "--m-long", "m-arg-value-2", "--l-long", "l-arg-value-1", "--c-long", 0,
    },
    {
        "test", "-e", 0,
    },
    ...
    },
    {
        ...
        "-m",
        "m-arg-value-2",
        "--l-long=l-arg-value-1",
        "--h-long=h-arg-value-1",
        0,
    },
    {
        0,
...
static const ulib_option smk_options[]
    = {{.key = 'a', .name = "all", .help = "\t\t\tUnconditionally rebuild targets"},

       {.key = 'c', .name = "clean", .help = "\t\t\tClean the project"},

       {.key = 'C', .name = "realclean", .help = "\t\tReally clean the project"},

       {.key = 'f',
        .name = "file",
        .flags = ulib_option_required_arg,
        .arg = "<name>",
        .help = "\tName of the makefile"},

       {.key = 'h', .name = "help", .help = "\t\t\tDisplay usage information"},

       {.key = 'i', .name = "install", .help = "\t\tInstall the package"},

       {.key = 'j',
        .name = "jobs",
        .flags = ulib_option_required_arg,
        .arg = "<num>",
        .help = "\tRun multiple jobs in parallel"},

       {.key = 'k',
        .name = "keep-going",
        .help = "\t\tKeep going when some targets can't be made"},

       {.key = 'n', .name = "dry-run", .help = "\t\tDo not execute commands"},

       {.key = 'o',
        .name = "output",
        .flags = ulib_option_required_arg,
        .arg = "<name>",
        .help = "\tSpecify top level build directory"},
       ...
       {.key = 'q', .name = "quiet", .help = "\t\t\tSuppress progress messages"},

       {.key = 's',
        .name = "subdir",
        .flags = ulib_option_required_arg,
        .arg = "<name>",
        .help = "\tSpecify build subdirectory"},

       {.key = 'u', .name = "uninstall", .help = "\t\tUninstall the package"},

       {.key = 'V', .name = "version", .help = "\t\tDisplay version"},

       {.key = 'v', .name = "verbose", .help = "\t\tVerbose messages"},

       {.key = 'x', .name = "xml", .help = "\t\t\tGenerate XML report"},
