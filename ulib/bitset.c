...
int
ulib_bitset_set_bits(ulib_bitset *set, unsigned int n, const unsigned int *idx) {
    ...
    if (set->used_len < mx_idx + 1) {
        memset(elt + set->used_len, 0, (mx_idx - set->used_len + 1) * sizeof(bitset_elt));
...
void
ulib_bitset_clear_bits(ulib_bitset *set, unsigned int n, const unsigned int *idx) {
    unsigned int i;
    bitset_elt *elt;
...
int
ulib_bitset_or(ulib_bitset *restrict dst,
...
int
ulib_bitset_destr_or(ulib_bitset *restrict dst, const ulib_bitset *restrict src) {
    unsigned int i, mn, mx;
    bitset_elt *restrict d;
...
int
ulib_bitset_destr_or_chg(ulib_bitset *restrict dst, const ulib_bitset *restrict src) {
    unsigned int i, mn, mx;
    bitset_elt *restrict d;
    const bitset_elt *restrict s;
    bitset_elt chg, tmp;
...
int
ulib_bitset_destr_and(ulib_bitset *restrict dst, const ulib_bitset *restrict src) {
    unsigned int i, mn;
    bitset_elt *restrict d;
    const bitset_elt *restrict s;
...
/* Destructive set theoretic intersection: DST &= SRC.  Returns
   ...
   otherwise. */
int
ulib_bitset_destr_and_chg(ulib_bitset *restrict dst, const ulib_bitset *restrict src) {
    unsigned int i, mn;
    bitset_elt *restrict d;
    const bitset_elt *restrict s;
    bitset_elt chg, tmp;
...
int
ulib_bitset_destr_andn(ulib_bitset *restrict dst, const ulib_bitset *restrict src) {
    unsigned int i, mn;
    bitset_elt *restrict d;
    const bitset_elt *restrict s;
...
/* Destructive set theoretic difference: DST &= ~SRC.  Returns
   ...
   otherwise.  */
int
ulib_bitset_destr_andn_chg(ulib_bitset *restrict dst, const ulib_bitset *restrict src) {
    unsigned int i, mn;
    bitset_elt *restrict d;
    const bitset_elt *restrict s;
    bitset_elt tmp, chg;
...
int
ulib_bitset_or_andn(ulib_bitset *restrict dst,
                    const ulib_bitset *restrict src1,
                    const ulib_bitset *restrict src2,
...
ulib_bitset_max(const ulib_bitset *set) {
    ...
    return ((set->used_len - 1) * sizeof(bitset_elt) * CHAR_BIT + bitset_elt_ffs(*elt)
            + 1);
}

/* Check whether set A is a subset of set B.  */
int
ulib_bitset_is_subset(const ulib_bitset *restrict a, const ulib_bitset *restrict b) {
    unsigned int n;
