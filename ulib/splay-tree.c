...
ULIB_SPLAY_TREE(splay)(ULIB_SPLAY_TREE_TYPE *t, ULIB_SPLAY_TREE_KEY_TYPE k) {
...
ULIB_STATIC int
ULIB_SPLAY_TREE(insert)(ULIB_SPLAY_TREE_TYPE **pt, ULIB_SPLAY_TREE_TYPE *k) {
...
ULIB_STATIC ULIB_SPLAY_TREE_TYPE *
ULIB_SPLAY_TREE(delete)(ULIB_SPLAY_TREE_TYPE **r, ULIB_SPLAY_TREE_KEY_TYPE k) {
