...
/* Splay a tree. */
ULIB_STATIC ULIB_SPLAY_TREE_TYPE *ULIB_SPLAY_TREE(splay)(ULIB_SPLAY_TREE_TYPE *,
                                                         ULIB_SPLAY_TREE_KEY_TYPE);

/* Insert a node into the tree.  */
ULIB_STATIC int ULIB_SPLAY_TREE(insert)(ULIB_SPLAY_TREE_TYPE **, ULIB_SPLAY_TREE_TYPE *);

/* Delete a key from the tree.  */
ULIB_STATIC ULIB_SPLAY_TREE_TYPE *ULIB_SPLAY_TREE(delete)(ULIB_SPLAY_TREE_TYPE **,
                                                          ULIB_SPLAY_TREE_KEY_TYPE);
...
static inline int
#endif
ULIB_SPLAY_TREE(lookup)(ULIB_SPLAY_TREE_TYPE **r, ULIB_SPLAY_TREE_KEY_TYPE k) {
