...
ULIB_IF int ulib_hash_init(ulib_hash *, unsigned int, ulib_hash_func, ulib_hashcmp_func);
...
/* Visit each element of the hash table.  Invoke the function VISIT
   ...
   user data DATA.  */
ULIB_IF void ulib_hash_traverse(ulib_hash *, ulib_visit_func visit, void *data);
